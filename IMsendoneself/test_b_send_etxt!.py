...
class Imtest(unittest.TestCase):
    ...
    def test_send_txt(self):
        ...
        print u"进入首页" 
        time.sleep(10)
        self.driver.swipe(600,960,60,960,500)#左划 (810,960,54,960,500)
        time.sleep(2)
        ...
        self.driver.find_element_by_id("chatting_content_et").send_keys(text1)#hello tester
        ...
        action1.long_press(el,duration=5000).perform()#长按       
