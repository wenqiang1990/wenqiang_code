...
class set_driver(object):  
    ...
    def get_driver(self,device='s',port='4723'):
        desired_caps = {}
        ...
        desired_caps['appPackage'] = 'com.yuntongxun.youhui'
        desired_caps['appActivity'] = 'com.yuntongxun.youhui.ui.activity.GuidePageActivity' #com.yuntongxun.pluginexample.ui.LauncherUI
