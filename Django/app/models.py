...
class RedminBugdata(models.Model):
    ...
    conner = models.CharField(max_length=255, blank=True, null=True)
    developer = models.CharField(max_length=255, blank=True, null=True)
    createdate = models.CharField(max_length=255, blank=True, null=True)
...
class RedminStatisticaldata(models.Model):
    ...
    developer = models.CharField(max_length=255, blank=True, null=True)
    createdate = models.CharField(max_length=255, blank=True, null=True)
    writetime = models.CharField(max_length=255, blank=True, null=True)
