...
class Imtest(unittest.TestCase):
    ...
    def test_revocation(self):  
        ...
        driver.find_element_by_id("com.yuntongxun.eckuailiao:id/btn_pick_photo").click()#点击从相册选择
        time.sleep(2)
        ...
        self.driver.find_element_by_id("com.sec.android.gallery3d:id/save").click()#三星s5点击保存
        time.sleep(2)
