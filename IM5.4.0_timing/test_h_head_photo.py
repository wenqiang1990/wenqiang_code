...
class Imtest(unittest.TestCase):
    ...
    def test_head_photo(self):  
        ...
        driver.find_element_by_id("com.yuntongxun.eckuailiao:id/btn_pick_photo").click()#点击相册
        time.sleep(2)
        self.driver.find_element_by_id("android:id/icon").click()#相册
        time.sleep(2)
        self.driver.find_element_by_id("android:id/up").click()#目录
        time.sleep(2)
        self.driver.find_element_by_id("com.sec.android.gallery3d:id/list_item_title").click()#
        time.sleep(2)
        self.driver.tap([(150,400)])
...
if __name__ == "__main__":
    ...
    suite.addTest(Imtest("test_head_photo"))
    # 执行测试
