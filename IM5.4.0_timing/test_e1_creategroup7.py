...
class Imtest(unittest.TestCase):
    ...
    def test_creategroup(self):  
        '''创建非公开群组名称中文英文数字字符混合，群组类型为出国，群公告ascii字符，省份为空'''
        driver = self.driver
        ...
        driver.find_element_by_id("com.yuntongxun.eckuailiao:id/ed_notice").send_keys(u"！@！#￥%……&*（）——+《》？“、；")#输入公告      
        ...
        driver.find_element_by_name(u"出国").click()#群组类型
