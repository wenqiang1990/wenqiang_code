...
class Imtest(unittest.TestCase):
    ...
    def test_creategroup(self):  
        ...
        driver.find_element_by_id("com.yuntongxun.eckuailiao:id/Refuse_btn").click()#点击拒绝按钮
        ...
        el=driver.find_element_by_id("com.yuntongxun.eckuailiao:id/last_msg_tv").get_attribute("text")
