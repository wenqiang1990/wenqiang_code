...
class Imtest(unittest.TestCase):
    ...
    def test_send_voicemessage(self):
        ...
        self.driver.find_element_by_id("com.yuntongxun.eckuailiao:id/layout_cancel_changevoice").click()#点击取消
        self.driver.find_element_by_id("com.yuntongxun.eckuailiao:id/chatting_mode_btn").click()       
        self.driver.find_element_by_id("com.yuntongxun.eckuailiao:id/chatting_mode_btn").click()
        action1 = TouchAction(self.driver)  
        el = self.driver.find_element_by_id("voice_record_imgbtn_biansheng")
        action1.long_press(el,duration=65000).perform()
        ...
        l=l.split('"')
        l=l[0]
        assert_equal(l, "60", msg="Voice message time display is not correct")
