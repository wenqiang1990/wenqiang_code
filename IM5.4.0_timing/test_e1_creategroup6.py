...
class Imtest(unittest.TestCase):
    ...
    def test_creategroup(self):  
        '''创建非公开群组名称中文英文数字字符混合，省市为汉字字母组合，群组类型为驴友，群组公告为空'''
        driver = self.driver
        ...
        driver.find_element_by_id("com.yuntongxun.eckuailiao:id/ed_province").send_keys(u"黑龙江Province")
        driver.find_element_by_id("com.yuntongxun.eckuailiao:id/ed_city").send_keys(u"Harbin市aaaaaaaaaaaaa")
        ...
        driver.find_element_by_name(u"同事").click()#群组类型
