...
class Imtest(unittest.TestCase):
    ...
    def test_joingroup(self):  
        ...
        login.test_login(self,phoneid = member)#被踢出成员登录
        print "被踢出成员登录"
        #搜索群组
        ...
        driver.find_element_by_name(u"按群组名称模糊查询").click()#使用群组名称, 搜索
        driver.find_element_by_id("com.yuntongxun.eckuailiao:id/search_flite").send_keys("group")#点击群组管理  
        driver.find_element_by_id("com.yuntongxun.eckuailiao:id/text_right").click()#点击确定
        time.sleep(2)
        driver.find_element_by_name(el).click()#点击群组
        time.sleep(2)
        ...
        driver.press_keycode('4')
        logout.test_logout(self)#退出登录
        login.test_login(self,phoneid ="13366778604")#登录       
        #管理员同意群组加入申请
        time.sleep(3)
        ...
        #assert_equal(el,u"3人",msg=u'申请人加入群组失败')
        print "申请人成功加入群"                
...
if __name__ == "__main__":
    ...
    suite.addTest(Imtest("test_joingroup"))
    # 执行测试
