...
class V2(unittest.TestCase):
    ...
    def test_v2(self):    
        ...
        driver.find_element_by_link_text(u"批量入库(新)").click()
        time.sleep(2)
        frame=driver.find_element_by_xpath("/html/body/div/div[1]/div[3]/div/iframe[2]")
        driver.switch_to_frame(frame)
        driver.find_element_by_xpath("/html/body/div[2]/div/div[4]/div/div[1]/div/div/textarea").click()
        ...
        for i in range(nrows): # 循环逐行打印
            ...
            list.append('\n') #添加换行符
        driver.find_element_by_xpath("/html/body/div[2]/div/div[4]/div/div[1]/div/div/textarea").send_keys(list)
        driver.find_element_by_id("btnStartInbound").click()
        time.sleep(12)
