...
class readyH(object):  
    ...
    def get_driver(self):  
        ...
        desired_caps['appPackage'] = 'com.yuntongxun.rongxin.lite' #com.yuntongxun.eckuailiao
        desired_caps['appActivity'] = 'com.yuntongxun.pluginexample.ui.LauncherUI' #com.yuntongxun.ecdemo.ui.account.SplashActivity
    ...
    def disdrop(self):
        ...
        '''
    def main_case(self):
        #下载，安装app、运行appium，获取driver，驱动删除app
        #download() 
        #time.sleep(10)
...
a=readyH('3a11d697','F:/542demo/Yuntx_Android_Rongxin_v5.1.3.2.debug_RongXinDebug.apk')#联想P1 3a11d697  三星 e52f9b61    oppoR9s 37fdd8a9   
a.main_case()
