...
class WebLogin(unittest.TestCase):
    ...
    def test_hmail(self):
        ...
        driver.find_element_by_id("ToAddress").send_keys(u"1详细地址，我要填写很多位a。")
        ...
        driver.find_element_by_id("Telephone").send_keys("01099999999")
        #driver.find_element_by_xpath("/html/body/div[2]/div/div[2]/div/div/div[3]/div[2]/form/table/tbody/tr[10]/td[2]/span[2]/input").click()
