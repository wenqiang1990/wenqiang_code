...
class set_driver(object):  
    ...
    def get_driver(self,device='192.168.1.103:5555',port='4723'):
        desired_caps = {}
        ...
        desired_caps['appPackage'] = 'com.yuntongxun.rongshi'
        desired_caps['appActivity'] = 'com.yuntongxun.youhui.ui.activity.LauncherUI' #com.yuntongxun.pluginexample.ui.LauncherUI
